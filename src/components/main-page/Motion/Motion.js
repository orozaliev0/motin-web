                        ...
                        <div className="motion--block">
                            <div className="motion--titles">
                                ...
                                <div className="motion--left">
                                    <h1 className="motion--title2">18 февраля <br/> <span
                                        className="motion--desc2">в</span> 18:00 <span
                                        className="motion--desc2">мастер класс <br/>  по </span> FRONTEND</h1>
