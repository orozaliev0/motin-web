...
import figma from '../../image/frontEnd/different.png'
const Frontend = () => {
                    ...
                    <div className="container">
                        <div className="accordionFront">
                            <div className="accord" onClick={() => {
                                ...
                                setSelected4(false)
                                setSelected5(false)
                            }} style={{height: selected ? '555px' : '', transition: '0.9s',}}>
                                ...
                                {
                                    selected ?
                                        <div className='accord--block' style={{
                                            display: "flex",
                                            justifyContent: "space-between",
                                            transition: '0s'
                                        }}>
                                           <div>
                                               <h1>В этом модуле вы получите представление о том, в чем разница между UX и
                                                   UI, а также почему они неразрывно связаны между собой. Мы обсудим, что
                                                   такое интерфейс и затронем тему классификации дизайна и сайтов. Вы
                                                   узнаете, какими принципами и в каком порядке важно руководствоваться в
                                                   процессе проектирования, получите представление о том, как пользователи
                                                   обрабатывают данные, изучите приёмы управления их вниманием и эмоциями.
                                                   Научитесь работать в графическом редакторе Figma и пройдёте первые этапы
                                                   погружения в UX/UI-дизайн.</h1>
                                               <ul>
                            ...
                            <div className="accord" onClick={() => {
                                ...
                                <div className="accord--rightBlock">
                                    <MdKeyboardArrowDown className='ml-12'
                                                         style={{transform: selected2 ? "rotate(180deg)" : ""}}/>
                                </div>
                            </div>
                            <div className="accord" onClick={() => {
                                ...
                                <div className="accord--rightBlock">
                                    <MdKeyboardArrowDown className='ml-3'
                                                         style={{transform: selected3 ? "rotate(180deg)" : ""}}/>
                                </div>
                            </div>
                            <div className="accord" onClick={() => {
                                ...
                                <div className="accord--rightBlock">
                                    <MdKeyboardArrowDown style={{transform: selected4 ? "rotate(180deg)" : ""}}/>
                                </div>
                            </div>
                            <div className="accord" onClick={() => {
                                ...
                                <div className="accord--rightBlock">
                                    <MdKeyboardArrowDown style={{transform: selected5 ? "rotate(180deg)" : ""}}/>
                                </div>
                            </div>
                        </div>
                    </div>
